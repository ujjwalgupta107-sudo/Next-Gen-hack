...
const DEFINE_PLUGIN_MIGRATION_HINT = "To migrate a plugin to Hardhat 3, export a plugin object with definePlugin from hardhat/plugins and register hook handlers in its hookHandlers field.";
/**
...
export function extendEnvironment(..._args) {
    throwUsingHardhat2PluginError("extendEnvironment", DEFINE_PLUGIN_MIGRATION_HINT);
}
/**
 * @deprecated This function is part of the Hardhat 2 plugin API.
 */
...
export function scope(..._args) {
    throwUsingHardhat2PluginError("scope", "To migrate tasks to Hardhat 3, define them with task or emptyTask from hardhat/config and include them in a plugin exported with definePlugin from hardhat/plugins.");
}
/**
 * @deprecated This function is part of the Hardhat 2 plugin API.
 */
export function subtask(..._args) {
    throwUsingHardhat2PluginError("subtask", "To migrate subtasks to Hardhat 3, define them as nested tasks with task or emptyTask from hardhat/config and include them in a plugin exported with definePlugin from hardhat/plugins.");
}
