...
const nodeAction = async (args, hre) => {
    ...
    const { networkConfig, provider } = await hre.network.create(connectionParams);
    assertHardhatInvariant(provider instanceof EdrProvider, "Provider must be EdrProvider, since only edr networks are supported");
