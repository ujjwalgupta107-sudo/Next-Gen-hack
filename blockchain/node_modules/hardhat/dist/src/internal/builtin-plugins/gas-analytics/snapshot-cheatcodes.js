...
export function compareSnapshotCheatcodes(previousSnapshotsMap, currentSnapshotsMap) {
    const added = [];
    const removed = [];
    const changed = [];
...
export async function checkSnapshotCheatcodes(basePath, suiteResults) {
    ...
    const comparison = compareSnapshotCheatcodes(previousSnapshotCheatcodes, snapshotCheatcodes);
    return {
