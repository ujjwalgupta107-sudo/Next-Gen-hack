    ...
    async #getFileContent(file) {
        switch (file.type) {
            ...
            case ResolvedFileType.PROJECT_FILE:
                ...
                return await this.#hooks.runHandlerChain("solidity", "preprocessProjectFileBeforeBuilding", [file.inputSourceName, file.fsPath, file.content.text, solcVersion], async (_context, nextInputSourceName, nextFsPath, nextFileContent, nextSolcVersion) => {
                    for (const [paramName, expectedParamValue, actualParamValue] of [
                        ...
                        if (expectedParamValue !== actualParamValue) {
                            throw new HardhatError(HardhatError.ERRORS.CORE.HOOKS
