...
export function convert(prefix) {
    const convertTask = emptyTask([...prefix, "convert"], "Convert values between common Ethereum representations").build();
    const padTask = buildUtilsTask(task([...prefix, "convert", "pad"], "Pad a hex string to a given byte length")
