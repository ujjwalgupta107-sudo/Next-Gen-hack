...
import { StackTraceEntryType, CheatcodeErrorCode, } from "../network-manager/edr/stack-traces/solidity-stack-trace.js";
import { getCheatcodeSuggestion } from "../network-manager/edr/stack-traces/stack-trace-solidity-errors.js";
export function getMessageFromLastStackTraceEntry(stackTraceEntry) {
    switch (stackTraceEntry.type) {
        ...
        case StackTraceEntryType.FUNCTION_NOT_PAYABLE_ERROR:
            return `Non-payable function was called with value ${stackTraceEntry.value.toString(10)}`;
        ...
        case StackTraceEntryType.FALLBACK_NOT_PAYABLE_ERROR:
            return `Fallback function is not payable and was called with value ${stackTraceEntry.value.toString(10)}`;
        case StackTraceEntryType.FALLBACK_NOT_PAYABLE_AND_NO_RECEIVE_ERROR:
            return `There's no receive function, fallback function is not payable and was called with value ${stackTraceEntry.value.toString(10)}`;
