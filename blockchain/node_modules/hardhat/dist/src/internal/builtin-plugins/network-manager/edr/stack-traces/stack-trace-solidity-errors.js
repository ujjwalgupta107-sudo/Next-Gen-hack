...
import { StackTraceEntryType, CheatcodeErrorCode, CONSTRUCTOR_FUNCTION_NAME, PRECOMPILE_FUNCTION_NAME, UNKNOWN_FUNCTION_NAME, UNRECOGNIZED_CONTRACT_NAME, UNRECOGNIZED_FUNCTION_NAME, } from "./solidity-stack-trace.js";
const CHEATCODE_SUGGESTIONS = {
    "eip712HashType(string,string)": {
        message: "Providing a path to a bindings file is not supported, please use the eip712HashType(string calldata typeNameOrDefinition) cheatcode instead.",
        docsUrl: "https://hardhat.org/docs/reference/cheatcodes/utilities/eip712-hash-type",
    },
};
export function getCheatcodeSuggestion(cheatcode) {
            ...
            if (stackTraceEntry.details !== undefined) {
                switch (stackTraceEntry.details.code) {
                    case CheatcodeErrorCode.UnsupportedCheatcode:
                        ...
                        const suggestion = getCheatcodeSuggestion(stackTraceEntry.details.cheatcode);
