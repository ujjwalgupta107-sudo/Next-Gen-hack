...
export class ResolvedTask {
    ...
    async run(taskArguments = {}) {
        ...
        const next = async (nextTaskArguments, currentIndex = this.actions.length - 1) => {
            ...
            if (currentIndex === 0) {
                ...
                return await actionFn(nextTaskArguments, this.#hre);
            }
            return await actionFn(nextTaskArguments, this.#hre, async (newTaskArguments) => {
    ...
    #validateRequiredArgument(argument, value) {
        if (isArgumentRequired(argument.type, argument.defaultValue) &&
            value === undefined) {
            throw new HardhatError(HardhatError.ERRORS.CORE.TASK_DEFINITIONS
