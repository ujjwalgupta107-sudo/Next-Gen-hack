...
export declare function initHardhat3NonInteractive(options: NonInteractiveInitHardhat3Options): Promise<void>;
/**
 ...
 */
export declare function getTemplate(template?: string, includeAvailableTemplatesInErrors?: boolean): Promise<[Template, Promise<boolean>]>;
/**
 * Prints the list of available templates.
 */
export declare function printTemplatesList(print?: (message: string) => void): Promise<void>;
/**
...
export declare function assertNoNonInteractiveClashes(workspace: string, template: Template): Promise<void>;
export declare function copyProjectFilesNonInteractive(workspace: string, template: Template): Promise<void>;
/**
 ...
 */
export declare function installProjectDependencies({ workspace, template, install, update, formatSuccessMessage, }: {
    workspace: string;
    template: Template;
    install?: boolean;
    update?: boolean;
