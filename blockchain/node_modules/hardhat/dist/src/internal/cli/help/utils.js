...
export function parseOptions(task) {
    ...
    for (const { name, description, defaultValue, type, } of task.positionalArguments) {
...
export function getUsageString(task, options, positionalArguments, { command = "hardhat" } = {}) {
