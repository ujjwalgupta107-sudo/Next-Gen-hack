...
export declare function getUsageString(task: Task, options: ReturnType<typeof parseOptions>["options"], positionalArguments: ReturnType<typeof parseOptions>["positionalArguments"], { command }?: {
    command?: "hardhat" | "hhu";
}): string;
export {};
