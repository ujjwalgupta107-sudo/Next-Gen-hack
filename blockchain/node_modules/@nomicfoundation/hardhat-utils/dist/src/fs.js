...
import { collectAllDirectoriesMatching, collectAllFilesMatching, } from "./internal/fs.js";
...
export async function readJsonFileAsStream(absolutePathToFile) {
    ...
    try {
        ...
        return await parseJsonStream(fileHandle.createReadStream());
    }
    catch (e) {
        ensureError(e);
 ...
 * @throws FileSystemAccessError for any other error.
 */
export async function readdirOrEmpty(absolutePathToDir) {
    try {
 ...
 */
export async function exists(absolutePath, options = {}) {
 ...
 * @throws FileSystemAccessError for any other error.
 */
export async function symlink(target, linkPath) {
    try {
