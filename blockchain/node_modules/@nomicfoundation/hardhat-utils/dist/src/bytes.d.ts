 ...
 */
export declare function bytesToUtf8String(bytes: Uint8Array): string;
/**
 ...
 */
export declare function bytesIncludesUtf8String(haystack: Uint8Array, needle: string): boolean;
/**
 ...
 */
export declare function parseJsonBytes<T>(bytes: Uint8Array): Promise<T>;
